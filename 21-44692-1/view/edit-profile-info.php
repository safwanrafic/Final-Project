...
<br>&nbsp;&nbsp;&nbsp;<a href="user-home.php">< Back</a><br><br><br><br>
    <table width="21%" border="0" cellspacing="0" cellpadding="25" align="center">
        <tr>
            <td>
                <form method="post" action="../controller/edit-information-controller.php"  onsubmit="return isValid(this);">
                    ...
                    <input type="text" name="email" size="43px" value= "<?php echo "{$row['Email']}"; ?>" onkeyup="checkEmailValidity(this.value)">
